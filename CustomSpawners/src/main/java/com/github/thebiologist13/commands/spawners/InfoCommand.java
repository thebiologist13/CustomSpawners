...
public class InfoCommand extends SpawnerCommand {
	...
	private String[] getInfo(Spawner s) {
		...
		if(!s.getName().isEmpty()) {
			header += " (" + s.getName() + ChatColor.GOLD + ")";
		}
		...
		String timeEnabled = (s.hasKillTime()) ? "(Enabled)" : "(Disabled)";
		
		String rangeEnabled = (s.hasKillRange()) ? "(Enabled)" : "(Disabled)";
		...
		String[] message = {
				...
				ChatColor.GOLD + "Spawn on Enter: " + s.isSpawnOnEnter(),
				ChatColor.GOLD + "Track Nearby Only: " + s.isTrackNearby(),
				ChatColor.GOLD + "Mobs Capped: " + s.isCapped(),
				ChatColor.GOLD + "Spawn Times: " + times,
				ChatColor.GOLD + "Kill Mobs After: " + s.getKillTime() + " ticks " + timeEnabled,
				ChatColor.GOLD + "Kill Mobs Farther Than: " + s.getKillRange() + " blocks " + rangeEnabled,
