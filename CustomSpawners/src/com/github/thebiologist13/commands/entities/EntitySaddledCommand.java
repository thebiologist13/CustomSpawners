...
public class EntitySaddledCommand extends SpawnerCommand {
	...
	public void run(CommandSender arg0, Command arg1, String arg2, String[] arg3) {
		...
		//Command Syntax = /entities setsaddled [id] <true or false>
		...
		boolean value = false;
		//Permissions
		String perm = "customspawners.entities.setsaddled";
		...
		if(p.hasPermission(perm)) {
			...
			//Success
			p.sendMessage(ChatColor.GREEN + "Successfully set the saddled value of entity with ID " + 
