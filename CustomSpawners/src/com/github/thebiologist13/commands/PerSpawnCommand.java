...
public class PerSpawnCommand extends SpawnerSubCommand {
	...
	public void run(CommandSender arg0, Command arg1, String arg2, String[] arg3) {
		...
		//Permission checking
		if(p.hasPermission("customspawners.setmobsperspawn")) {
			...
			s.mobsPerSpawn = mobsPerSpawn;
			
			//Success message
			p.sendMessage(ChatColor.GREEN + "Set the mobs per spawn of the spawner with ID " + ChatColor.GOLD +
					String.valueOf(s.id) + ChatColor.GREEN + " to " + ChatColor.GOLD + String.valueOf(mobsPerSpawn) + 
					ChatColor.GREEN + "!");
		}
	}
}
