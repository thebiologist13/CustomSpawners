...
public class EntityHealthCommand extends SpawnerCommand {
	...
	public void run(CommandSender arg0, Command arg1, String arg2, String[] arg3) {
		...
		//Command Syntax = /entities sethealth [id] <health>
		...
		//Permissions
		String perm = "customspawners.entities.sethealth";
		...
		if(p.hasPermission(perm)) {
			if(CustomSpawners.entitySelection.containsKey(p) && arg3.length == 2) {
				...
				//Success
				p.sendMessage(ChatColor.GREEN + "Successfully set the health of spawnable entity with ID " 
