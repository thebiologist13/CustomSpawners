...
public class EntityAngryCommand extends SpawnerCommand {
	...
	public void run(CommandSender arg0, Command arg1, String arg2, String[] arg3) {
		...
		//Command Syntax = /entities setangry [id] <true or false>
		...
		boolean value = false;
		//Permissions
		String perm = "customspawners.entities.setangry";
		...
		if(p.hasPermission(perm)) {
			...
			//Success
			p.sendMessage(ChatColor.GREEN + "Successfully set the angry value of entity with ID " + 
