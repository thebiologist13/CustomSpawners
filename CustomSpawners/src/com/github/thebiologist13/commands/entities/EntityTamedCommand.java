...
public class EntityTamedCommand extends SpawnerCommand {
	...
	public void run(CommandSender arg0, Command arg1, String arg2, String[] arg3) {
		...
		//Command Syntax = /entities settamed [id] <true or false>
		...
		boolean value = false;
		//Permissions
		String perm = "customspawners.entities.settamed";
		...
		if(p.hasPermission(perm)) {
			...
			//Success
			p.sendMessage(ChatColor.GREEN + "Successfully set the tamed value of entity with ID " + 
