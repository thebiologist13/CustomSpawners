...
public class SpawnManager extends AbstractSpawnManager {
	...
	public boolean isSolidBlock(Block block){
        return block.getTypeId() != 0 && net.minecraft.server.v1_5_R3.Block.byId[block.getTypeId()].material.isSolid();
    }
...
//				net.minecraft.server.v1_5_R3.Entity nmEntity = ((CraftEntity) e).getHandle();
//
	...
	public Entity spawnTheEntity(ISpawnableEntity spawnType, Location spawnLocation) {
		...
		if(spawnType.getType().equals(EntityType.DROPPED_ITEM)) {
			...
			EntityPotion ent = new EntityPotion(nmsWorld, spawnLocation.getX(), spawnLocation.getY(), 
					spawnLocation.getZ(), new net.minecraft.server.v1_5_R3.ItemStack(373, 1, data));
		...
		net.minecraft.server.v1_5_R3.Entity entity0 = ((CraftEntity) e).getHandle();
