...
public class HelpCommand extends CustomSpawnersCommand {
	...
	public void run(CommandSender sender, String subCommand, String[] args) {
		...
		final String[] HELP_MESSAGE_MAIN = {
				...
				ChatColor.GOLD + "/spawners killrange [id] <range>" + ChatColor.GREEN + " -> Set the kill range.",
				ChatColor.GOLD + "/spawners usekillrange [id] <value>" + ChatColor.GREEN + " -> Set whether the kill range should be used.",
				ChatColor.GOLD + "/spawners killtime [id] <time>" + ChatColor.GREEN + " -> Set the kill time.",
				ChatColor.GOLD + "/spawners usekilltime [id] <value>" + ChatColor.GREEN + " -> Set whether the kill time should be used.",
				...
				ChatColor.GOLD + "/entities adddrop [id] <item>[:damage][%drop chance] <amount>" + ChatColor.GREEN + " -> Add an item to the drops.",
				ChatColor.GOLD + "/entities setdrops [id] <item>[:damage][%drop chance] <amount>" + ChatColor.GREEN + " -> Sets the mob's dropped item.",
				...
				ChatColor.GOLD + "/entities addattribute [id] <attribute type> <base> [modifier name, operator, amount;...]" + 
						ChatColor.GREEN + " -> Add an attribute.",
				ChatColor.GOLD + "/entities setattribute [id] <attribute type> <base> [modifier name, operator, amount;...]" + 
						ChatColor.GREEN + " -> Set the attribute.",
				ChatColor.GOLD + "/entities clearattributes [id]" + ChatColor.GREEN + " -> Clear attributes.",
				ChatColor.GOLD + "/entities horsetype [id] <horse type>" + ChatColor.GREEN + " -> Set the horse type.",
				ChatColor.GOLD + "/entities horsecolor [id] <horse color>" + ChatColor.GREEN + " -> Set the horse color.",
				ChatColor.GOLD + "/entities horsevariant [id] <horse variant>" + ChatColor.GREEN + " -> Set the horse variant.",
				ChatColor.GOLD + "/entities chests [id] <value>" + ChatColor.GREEN + " -> Whether the horse has chests or not.",
